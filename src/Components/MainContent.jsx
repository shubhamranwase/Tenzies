    ...
    return (
        <>
            ...
            <main className="flex flex-col justify-center items-center">
                <p className="instructions text-white text-xl w-80 h-30 text-center p-3">Roll until all dice are the same. Click each die to freeze it at its current value between rolls.</p>
                <div className="container h-100 w-120 flex flex-col items-center">
                    ...
                    <button ref={buttonRef} className="w-32 h-12 bg-amber-500 hover:bg-amber-600 hover:scale-110 active:scale-95 active:bg-amber-700 transition duration-400 ease-in-out text-white font-bold text-lg py-2 px-4 rounded-xl mt-4"
